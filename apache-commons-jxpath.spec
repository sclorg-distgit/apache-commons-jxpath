%{?scl:%scl_package apache-commons-jxpath}
%{!?scl:%global pkg_name %{name}}

Name:           %{?scl_prefix}apache-commons-jxpath
Version:        1.3
Release:        26.2%{?dist}
...
BuildRequires:  %{?scl_prefix}mvn(javax.servlet:jsp-api)
...
%changelog
* Thu Jun 22 2017 Michael Simacek <msimacek@redhat.com> - 1.3-26.2
- Mass rebuild 2017-06-22

* Wed Jun 21 2017 Java Maintainers <java-maint@redhat.com> - 1.3-26.1
